...
<head>
    ...
    <style>
        ...
        .header { 
            text-align: center; margin-bottom: 30px; border-bottom: 2px solid #000; padding-bottom: 10px; 
        }
        table { 
...
<body>
    <div class="header">
        <h2>{{ setting('platform_name', 'HRM System') }}h2>
        <p>{{ setting('platform_email', 'info@zulfytek.co.tz') }} | TIN: 123-456-789</p>
